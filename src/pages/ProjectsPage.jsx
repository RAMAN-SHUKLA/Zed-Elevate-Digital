...
const DEFAULT_PROJECTS = [
  ...
  { id: 2, title: "Rajasthan Heritage Tours", category: "branding", image: "https://images.unsplash.com/_WvFZN9Q-vY?w=1200&auto=format&fit=crop", link: "/case-studies/rajasthan-heritage" },
  { id: 3, title: "Mumbai Street Food Hub", category: "web", image: "https://images.unsplash.com/z5UMFvTVXZg?w=1200&auto=format&fit=crop", link: "/case-studies/mumbai-street-food" },
  { id: 4, title: "Kerala Ayurveda Center", category: "web", image: "https://images.unsplash.com/kEF2XCBE4TY?w=1200&auto=format&fit=crop", link: "/case-studies/kerala-ayurveda" },
  { id: 5, title: "Diwali Festive Campaign", category: "marketing", image: "https://images.unsplash.com/evtL96IfR2E?w=1200&auto=format&fit=crop", link: "/case-studies/diwali-campaign" },
  { id: 6, title: "Wedding Season Marketing", category: "marketing", image: "https://images.unsplash.com/g3ppTBTQam8?w=1200&auto=format&fit=crop", link: "/case-studies/wedding-marketing" },
];
...
export default function ProjectsPage() {
  ...
  useEffect(() => {
    ...
    const stored = localStorage.getItem('zed_projects_v9');
    if (!stored) {
      localStorage.setItem('zed_projects_v9', JSON.stringify(DEFAULT_PROJECTS));
